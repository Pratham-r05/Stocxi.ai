...
export default function DownloadReportButton({ symbol }: DownloadReportButtonProps) {
  ...
  return (
    <div ref={rootRef} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-[min(20rem,calc(100vw-1.5rem))] rounded-xl border border-zinc-700 bg-zinc-950 shadow-2xl shadow-black/60 overflow-hidden z-[70]">
